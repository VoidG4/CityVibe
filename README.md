...
> **Note:** This project was developed as part of a university semester assignment, fulfilling and exceeding all core and bonus requirements.
...
```bash
git clone https://github.com/YourUsername/UnipiCityVibe.git
```
